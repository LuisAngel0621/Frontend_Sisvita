...
fun QuestionItem(question: Question) {
    ...
    var selectedScale by remember { mutableStateOf(-1) }
    ...
    Column(
        ...
        ///////////////////////////////////////////////////////////////////////////////////////
        //SALIDA
        //ALMACENARA LA RESPUESTA DE LA ESTRUCTURA DE DATOS
        if (selectedOption != -1 && selectedScale != -1) {
            val answer = Answer(question.text, selectedOption, selectedScale)
            answers.add(answer)
        }
        ///////////////////////////////////////////////////////////////////////////////////////
    }
